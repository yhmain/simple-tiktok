...
func TestSelectUserByName100(t *testing.T) {
	...
	expectedResult := model.User{Id: 0, Name: "", Password: "", FollowCount: 0, FollowerCount: 0, IsFollow: false}
...
func TestSelectUserByName200(t *testing.T) {
	...
	expectedResult := model.User{Id: 2, Name: "admin", Password: "123456", FollowCount: 20, FollowerCount: 20, IsFollow: false}
	assert.Equal(t, expectedResult, user)
}
...
func TestInsertNewUser(t *testing.T) {
	err := InsertNewUser(model.User{Id: 1000, Name: "user1000", Password: "7777909"})
